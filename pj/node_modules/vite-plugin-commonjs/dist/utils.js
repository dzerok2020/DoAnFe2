...
exports.MagicString = exports.simpleWalk = exports.isCommonjs = exports.cleanUrl = exports.builtins = exports.KNOWN_CSS_TYPES = exports.KNOWN_ASSET_TYPES = exports.KNOWN_SFC_EXTENSIONS = exports.JS_EXTENSIONS = exports.hashRE = exports.queryRE = exports.singlelineCommentsRE = exports.multilineCommentsRE = void 0;
...
exports.builtins = [
    ...module_1.builtinModules.map(m => !m.startsWith('_')),
    ...module_1.builtinModules.map(m => !m.startsWith('_')).map(m => `node:${m}`)
];
// ------------------------------------------------- function
