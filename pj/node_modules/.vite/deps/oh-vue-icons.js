...
Please make sure you have imported this icon before using it.`), false) }, title: String, fill: String, scale: { type: [Number, String], default: 1 }, animation: { validator: (n) => ["spin", "spin-pulse", "wrench", "ring", "pulse", "flash", "float"].includes(n) }, hover: Boolean, flip: { validator: (n) => ["horizontal", "vertical", "both"].includes(n) }, speed: { validator: (n) => n === "fast" || n === "slow" }, label: String, inverse: Boolean }, setup(n) {
  ...
  }), f2 = computed(() => ({ "ov-icon": true, "ov-inverse": n.inverse, "ov-flip-horizontal": n.flip === "horizontal", "ov-flip-vertical": n.flip === "vertical", "ov-flip-both": n.flip === "both", "ov-spin": n.animation === "spin", "ov-spin-pulse": n.animation === "spin-pulse", "ov-wrench": n.animation === "wrench", "ov-ring": n.animation === "ring", "ov-pulse": n.animation === "pulse", "ov-flash": n.animation === "flash", "ov-float": n.animation === "float", "ov-hover": n.hover, "ov-fast": n.speed === "fast", "ov-slow": n.speed === "slow" })), m2 = computed(() => n.name ? u[n.name] : null), c2 = computed(() => m2.value ? `${m2.value.minX} ${m2.value.minY} ${m2.value.width} ${m2.value.height}` : `0 0 ${g2.value} ${w2.value}`), d2 = computed(() => {
    if (!m2.value)
      return 1;
    const { width: n2, height: o } = m2.value;
    return Math.max(n2, o) / 16;
  }), g2 = computed(() => l2.width || m2.value && m2.value.width / d2.value * h3.value || 0), w2 = computed(() => l2.height || m2.value && m2.value.height / d2.value * h3.value || 0), y = computed(() => h3.value !== 1 && { fontSize: h3.value + "em" }), b = computed(() => {
  ...
  return onMounted(() => {
    ...
    x();
  }), __spreadProps(__spreadValues({}, toRefs(s)), { children: a, icon: m2, klass: f2, style: y, width: g2, height: w2, box: c2, attribs: $, raw: b });
}, created() {
  const n = this.$parent;
