...
function syncTreeCreateListenerForView_(syncTree, view) {
  ...
  const tag = syncTreeTagForQuery_(syncTree, query2);
  return {
    hashFn: () => {
...
function repoGetValue(repo, query2) {
  ...
  return repo.server_.get(query2).then((payload) => {
    ...
    const events = syncTreeApplyServerOverwrite(repo.serverSyncTree_, query2._path, node);
...
function get(query2) {
  ...
  return repoGetValue(query2._repo, query2).then((node) => {
 ...
 * limitations under the License.
 */
//# sourceMappingURL=chunk-7XURHK2S.js.map
